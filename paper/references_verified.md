...
## 2026-09-03 第二轮核查：外置机器人 + 四手联弹

主张收窄为四个同时成立的条件：**外置机器人按键**（区别于装在琴内的 player-piano 机构）+ **同一台键盘** + **写定的四手联弹曲目** + **实时跟随真人**。逐条排除：

| 候选 | 为何不构成反例 |
|---|---|
| Yamaha AI 合奏 / Disklavier（2016）、Ghost in the Keys（2025）、Risset《Duet for One Pianist》（1989） | 机构内置于乐器，非外置 |
| WABOT-2（早稻田，1984）——外置人形，摄像头读谱，双手双脚演奏，能听真人歌手实时调速伴奏 | 跟随对象是歌手，两件不同乐器，非同一键盘，非四手联弹曲目。**四十年前的名机，需在文中被限定词挡住** |
| TeoTronico（Matteo Suzzi，2007–，53 根电磁铁手指，外置，可用于任何原声钢琴），与 Roberto Prosseda 演出 80+ 场 | 意大利文场次报道口径一致：两台钢琴分坐、轮流演奏做对比，非同时；且回放 MIDI，不跟随。中文报道称"能与人类四手连弹"，未获任何意/英文来源佐证，官网被网络策略拦截无法核对；用户自行查证后确认不成立 |
| Wang, Zhang & Iida（2024） | 外置、同一键盘、会跟随，但即兴和弦、单手，非写定四手联弹 |
| Tchaibotsky（Instructables 业余项目，8 根舵机手指 + 齿条平移，作者自述目的即"弹四手联弹"） | 仅 C 大调，回放 MIDI，不跟随，非文献 |
